...
public class FestivalDTORunner {
	...
	public static void main(String[] args) {
		...
		FestivalDTO festivalDTO2 = new FestivalDTO(5, "dasara", LocalDate.now(), LocalDate.of(2022, 6, 8),
				"holige", "mahalaxmi");
		...
		FestivalDTO festivalDTO1 = new FestivalDTO(5, "ugadi", LocalDate.now(), LocalDate.of(2022, 6, 8),
				"holige", "mahalaxmi");
		...
		try {
			...
			boolean save=festivalService.validateAndThenSave(festivalDTO);
